# Generated by Powerlevel10k configuration wizard on 2025-10-08 at 21:25 -03.
...
# flat tails, 2 lines, disconnected, no frame, sparse, fluent, transient_prompt,
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      (( $#branch > 30 )) && branch="$branch[1,30]…"  # <-- this line
    #   (( $#branch > 100 )) && branch[13,-13]="…"
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_PREFIX='⏱️'
  ...
  typeset -g POWERLEVEL9K_VCS_SHORTEN_STRATEGY=none
  typeset -g POWERLEVEL9K_VCS_SHORTEN_LENGTH=100
}
